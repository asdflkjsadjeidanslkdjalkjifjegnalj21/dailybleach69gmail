<!DOCTYPE html>
    ...
    <body class="bg-dark">
        <div class="container">
            <form method="POST" action="lid_send_admin.php" class="text-light mt-4" enctype="multipart/form-data" >
                <div class="form-row bg-dark border-rad p-2">
                    ...
                    <div class="form-group col-6">
                        <label for="niveau">Niveau</label>
                            <input type="number" step="1" name="niveau" id="niveau" class="form-control" required>
                    </div>
                    <div class="form-group col-6">
                        <label for="sl">Speciale rol</label>
