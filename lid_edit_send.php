...
$insert = "UPDATE leden SET Lid_nr = '$lid_nr', Wachtwoord = '$H_wachtwoord', Voornaam = '$voornaam', Tussenvoegsel = '$tussenvoegsel', Achternaam = '$achternaam', Geslacht = '$geslacht', Email = '$email', Telefoon_nr = '$T_nr' , Postcode = '$postcode', Adres = '$adres' WHERE Lid_nr = '$lid_nr' ";
